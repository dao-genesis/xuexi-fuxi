...
| 💧 **流体力学** | 教师 曾强 · 2026春 · 5 章 · 14 份课件 | [📖 打开复习页](https://zhouyoukang1234-spec.github.io/xuexi-fuxi/fluid-mechanics.html) |
| 🗺️ **地理信息系统 GIS** | 教师 黄源生 · 2026春 · 12 章 · 6 份课件 | [📖 打开复习页](https://zhouyoukang1234-spec.github.io/xuexi-fuxi/gis.html) |
| 🏙️ **环境规划与管理** | 教师 王思雨 · 2026春 · 6 章 · 11 份课件 | [📖 打开复习页](https://zhouyoukang1234-spec.github.io/xuexi-fuxi/environmental-planning.html) |
| 📜 **中国近现代史纲要** | 教师 亚里坤·买买提亚尔 · 2026春 | [📖 打开复习页](https://zhouyoukang1234-spec.github.io/xuexi-fuxi/modern-history.html) |

## 🧩 各科内容模块

- 🧪 **环境毒理学** — 导览×1 ｜ 复习资料×6 ｜ 例题精解 · 深化×1 ｜ 章节素材×7 ｜ 学习系统×3 ｜ 期末冲刺×3 ｜ 知识图谱×1 ｜ 原始课件 · 页图×1 ｜ 原始课件 · PDF原文×15
- ⚖️ **环境法学** — 导览×1 ｜ 复习资料×1 ｜ 例题精解 · 深化×1 ｜ 章节素材×6 ｜ 学习系统×3 ｜ 期末冲刺×3 ｜ 知识图谱×1 ｜ 原始课件 · 页图×1 ｜ 原始课件 · PDF原文×14
- 💧 **流体力学** — 导览×1 ｜ 复习资料×1 ｜ 例题精解 · 深化×1 ｜ 章节素材×5 ｜ 学习系统×3 ｜ 期末冲刺×3 ｜ 知识图谱×1 ｜ 原始课件 · 页图×1 ｜ 原始课件 · PDF原文×14
- 🗺️ **地理信息系统 GIS** — 导览×1 ｜ 复习资料×1 ｜ 例题精解 · 深化×1 ｜ 章节素材×12 ｜ 学习系统×3 ｜ 期末冲刺×3 ｜ 知识图谱×1 ｜ 原始课件 · 页图×1 ｜ 原始课件 · PDF原文×6
- 🏙️ **环境规划与管理** — 导览×1 ｜ 复习资料×1 ｜ 例题精解 · 深化×1 ｜ 章节素材×6 ｜ 学习系统×3 ｜ 期末冲刺×3 ｜ 知识图谱×1 ｜ 原始课件 · 页图×1 ｜ 原始课件 · PDF原文×11
